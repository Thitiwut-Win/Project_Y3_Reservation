...
export default function RegisterPage() {
	...
	if (status === "loading") return <p className="p-6 text-center">Checking session...</p>;
	...
	return (
		<main className="max-w-md mx-auto my-8 bg-white dark:bg-gray-800 p-6 rounded shadow">
			...
			<input
				type="text"
				placeholder="Name"
				className="w-full border border-gray-950 dark:border-gray-300 p-2 mb-3 rounded-lg"
				value={name}
